...
local function modified_buffer_indicator()
    if vim.bo.modifiable and vim.bo.modified then
        sethighlight("GalaxyModifiedBufferIndicator", {fg=colors.red})
        return "▮"
    else
        sethighlight("GalaxyModifiedBufferIndicator", {fg=colors.purple})
        return "▯"
    end
end
...
table.insert(Section.right, {
    ModifiedBufferIndicator = {
        provider = modified_buffer_indicator,
        highlight = {colors.purple, colors.bgdark},
    },
})

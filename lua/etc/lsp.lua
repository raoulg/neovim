...
vim.api.nvim_set_hl(0, "LspSagaFloatWinNormal", {fg=nil, bg=bgdark})
vim.api.nvim_set_hl(0, "LspFloatWinBorder", {fg=colors.pink, bg=nil})
vim.api.nvim_set_hl(0, "LspSagaBorderTitle", {fg=colors.purple, bg=nil})
vim.api.nvim_set_hl(0, "LspLinesDiagBorder", {fg=colors.comment, bg=nil})
vim.api.nvim_set_hl(0, "LspSagaRenameBorder", {fg=colors.comment, bg=nil})
vim.api.nvim_set_hl(0, "LspSagaHoverBorder", {fg=colors.comment, bg=nil})
vim.api.nvim_set_hl(0, "LspSagaSignatureHelpBorder", {fg=colors.comment, bg=nil})
vim.api.nvim_set_hl(0, "LspSagaCodeActionBorder", {fg=colors.pink, bg=nil})
vim.api.nvim_set_hl(0, "LspSagaAutoPreview", {fg=colors.comment, bg=nil})
vim.api.nvim_set_hl(0, "LspSagaDiagnosticBorder", {fg=colors.comment, bg=nil})
vim.api.nvim_set_hl(0, "LspSagaDiagnosticTruncateLine", {fg=colors.comment, bg=nil})

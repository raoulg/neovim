...
vim.api.nvim_set_hl(0, "Search", {bg=colors.green, bg=colors.bgdark, underline=true})
vim.api.nvim_set_hl(0, "IncSearch", {fg=colors.green, bg=colors.bgdark, underline=true})
...
vim.api.nvim_set_hl(0, "ErrorMsg", {fg=colors.foreground, bg=colors.red})
